...
class AtomEncoder(torch.nn.Module):
    ...
    def __init__(self, emb_dim, padding=False):
        ...
        self.emb_dim = emb_dim  # 🔹 这里添加 self.emb_dim，防止 AttributeError
    ...
    def forward(self, x):
        # print(f"self.atom_embedding_list 长度: {len(self.atom_embedding_list)}")
        #
        # print(f"full_atom_feature_dims: {full_atom_feature_dims}")
        x_embedding = 0
